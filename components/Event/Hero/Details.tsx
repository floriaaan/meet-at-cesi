...
export const HeroDetails = ({ event }: { event: ExtendedEvent }) => {
  ...
  return (
    <div className="flex flex-col items-start justify-between px-2 py-2 -mt-4 overflow-hidden text-sm font-bold sm:px-6 md:-mt-12 lg:mt-0 md:px-2 whitespace-nowrap bg-primary md:items-end">
      <div className="flex flex-col md:items-end">
        <div className="inline-flex items-start text-black truncate whitespace-pre-wrap md:whitespace-nowrap gap-x-1">
          <MdLocationPin className="w-4 h-4" />
          {location}
        </div>
        <div className="inline-flex items-center text-black truncate gap-x-1">
        ...
        <div className="inline-flex items-center text-black truncate sm:hidden gap-x-1">
