...
export const EventListItemSkeleton = () => {
	return (
		<div className="flex flex-col overflow-hidden border border-black opacity-75 md:flex-row decoration-dashed group">
			<div className="flex flex-col items-center justify-center w-auto h-24 bg-black md:h-auto shrink-0 md:aspect-square gap-y-1 md:w-28">
				<div className="w-8 h-2.5 bg-white animate-pulse"></div>
				<div className="w-16 h-4 bg-white animate-pulse"></div>
				<div className="w-24 h-px bg-white md:w-8 animate-pulse"></div>
				<div className="w-20 h-2 bg-white animate-pulse"></div>
				<div className="w-8 h-2 bg-white animate-pulse"></div>
			</div>
			...
			<div className="flex flex-col items-center justify-center w-8 h-8 ml-auto text-white bg-black border-t border-l border-black shrink-0 md:border-t-0 md:border-b">
				<Spinner />
			</div>
		</div>
	);
