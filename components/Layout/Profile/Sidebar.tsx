...
export const ProfileLayoutSidebar = () => {
	...
	return (
		<aside
			className="sticky flex-col justify-between hidden h-auto min-h-full px-6 py-6 overflow-y-auto top-6 grow w-72 xl:w-96 md:flex dark:bg-neutral-950 bg-neutral-50 "
			aria-label="Sidebar"
		>
